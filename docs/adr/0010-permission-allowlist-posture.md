...
- **AUTHORITY.** This Findings section is the single authoritative home for Claude Code permission-engine behavior claims in this repository. Other surfaces OPERATIONALIZE the resulting instruction or POINT here, and never independently assert engine behavior.
