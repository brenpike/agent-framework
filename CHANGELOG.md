...
- **ADR-0016** (`docs/adr/0016-structural-containment-of-write-capable-skills.md`): records that write-capable user-driven skills (`tdd`, `refactor-to-depth`) are structurally contained by tool capability + spawn topology — no per-skill preflight needed; referenced from `security-policy.md`.
