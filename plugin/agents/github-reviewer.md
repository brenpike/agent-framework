...
**No injection scan for checks:** CI check failures bypass Step 4 (injection scan) because their content (name, description, link) is machine-generated by CI providers, not user-authored prose.
...
2. Compare check name against the state ledger — skip checks already remediated or in-progress
...
5. Check failures bypass injection scan (machine-generated content)
