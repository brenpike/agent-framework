---
name: break-fix-detector
description: Detect break-fix-break cycles in the review loop by evaluating three signals. Returns signal results and whether to escalate.
tools: []
---
