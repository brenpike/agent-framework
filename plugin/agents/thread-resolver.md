...
description: Determine whether to resolve a GitHub PR review thread after a fix. Evaluates safety preconditions and pre-resolve re-fetch. Returns resolve | skip decision.
tools:
  - Read
  - Bash(gh api *)
---
