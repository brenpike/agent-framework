...
description: Classify a PR feedback item or local review finding using the classification taxonomy. Returns classification, severity category, and routing recommendation.
tools:
  - Read
---
