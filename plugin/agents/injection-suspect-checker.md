---
name: injection-suspect-checker
description: Check content fields for prompt injection patterns. Returns Result: detected | not-detected with pattern category.
tools:
  - Read
---
