...
- **Delegate next phase** only after both contradiction detection and reconstruction test pass: delegate with only the compact step-delta context, not the full prior phase report or tool outputs.
