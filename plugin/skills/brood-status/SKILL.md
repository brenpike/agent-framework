...
1. **Collect.** Run the committed entrypoint ONCE and capture its stdout as the status JSON:
   ...
   - **No pruning.** Terminal broods (completed/cancelled/failed) remain on disk and are shown with their terminal Status. Cleanup is a separate write-action tracked in #181 — do not delete or archive any directory from this skill.
