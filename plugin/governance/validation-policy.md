...
- `agent-framework:local-codex-review` — invoked by `agent-framework:review-loop-controller` during the pre-PR loop, or directly by users; not invoked directly by the orchestrator
